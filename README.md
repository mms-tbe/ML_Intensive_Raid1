...
Нами разработана модель машинного обучения, которая помогает маркетинговой команде Компании заранее находить
клиентов с высоким риском оттока (`Churn`), чтобы обзванивать их **до** ухода/отписки от услуг оператора.

## Бизнес-контекст и почему это влияет на метрику?

Стоимость **пропущенного оттока** (false negative — не позвонили тому клиенту, который по факту ушёл/отписался от услуг оператора)
